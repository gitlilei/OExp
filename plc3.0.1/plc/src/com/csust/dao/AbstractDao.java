...
import com.csust.impl.PackageEntity;
import com.csust.impl.PstmtSetter;
...
public class AbstractDao {
	 ...
	 * @throws Exception
	 */
	public final static int doUpdate(String sql,PstmtSetter pstmtSetter)throws Exception{
		int result = -1;
