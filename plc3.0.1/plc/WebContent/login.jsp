...
<script type="text/javascript" src="admin/js/plugins/jquery.cookie.js"></script>
<script type="text/javascript" src="admin/js/plugins/jquery.uniform.min.js"></script>
...
<body class="loginpage">
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="logo">
            	<h1 class="logo">plc<span>Login</span></h1>
				<span class="slogan">plc系统登陆</span>
            </div><!--logo-->
