	...
	<div id="featured">
		<div >
			<div class="body_left fl">
				<div class="m_left">
					...
					<ul class="m_table">
						...
						<li><a href="do.jsp?value=test" target="main">规章制度</a></li>
						
						<li><a href="do.jsp?value=biaoge" target="main">管理表格</a></li>
			...
			<div class="body_right fl">
				...
				<iframe name="main" height=800 width=100% scrolling="no" src="" frameborder=0 allowfullscreen ></iframe>
